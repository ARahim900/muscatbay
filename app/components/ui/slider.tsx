...
const Slider = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root> & { rangeClassName?: string; thumbClassName?: string; trackClassName?: string }
>(({ className, rangeClassName, thumbClassName, trackClassName, ...props }, ref) => (
    ...
    >
        <SliderPrimitive.Track className={cn("relative h-2 w-full grow overflow-hidden rounded-full bg-secondary", trackClassName)}>
            <SliderPrimitive.Range className={cn("absolute h-full bg-mb-primary", rangeClassName)} />
