...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: The recent activity feed filter buttons did not correctly filter alerts by all, critical, warning, and info categories or highlight the active filter as expected.")
