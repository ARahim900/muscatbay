...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: Dashboard did not render correctly in dark mode or accessibility contrast guidelines were not met as per the test plan.')
