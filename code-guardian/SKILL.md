...
```
references/muscat-bay-conventions.md   — naming, file structure, Tailwind theme, component patterns
references/react-nextjs-checklist.md   — React 19 hooks rules, Next.js 16 App Router patterns
references/supabase-security-checklist.md — auth, RLS, client usage, data fetching patterns
```
...
3. **Load reference checklists** from `references/` directory
