...
| Tests / checks | Vitest (322 tests), ESLint (incl. the design rule on migrated folders), `tsc --noEmit`, `next build` (+ `mobile/` `tsc --noEmit`) — all green as of 2026-09-03 |
...
- **#79 Design System v2.0 — foundation + Water (2026-09-02).** Branch
  ...
  KPI rows side by side. Left for the per-page migration sessions (all pre-existing,
