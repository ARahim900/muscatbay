...
- **Water 3D Map (third subsection) — new (2026-07-19).** Adds an interactive
  ...
  key; meter positions are provisional (no surveyed coordinates in the backend
  yet). type-check / lint / build / tests green. See `WATER_3D_MAP.md`. Awaiting
  review/merge.
