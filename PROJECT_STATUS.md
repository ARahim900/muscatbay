...
| Tests / checks | Vitest (322 tests), ESLint (incl. the design rule on migrated folders), `tsc --noEmit`, `next build` (+ `mobile/` `tsc --noEmit`) — all green as of 2026-09-02 |
...
- **Design-system migration in progress (2026-09-02).** Only Water is on
  ...
  now render in the intended muted grey.
