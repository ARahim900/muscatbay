...
- **Open 2026-09-10 — the trunk-main loss is large and now visible.** With the
  Direct Connections tab reconciling L1 against Σ zone bulks + Σ DC day by day
  (see §2, Water — Daily), Sep-26 days 1–9 show NAMA supply 12,224 m³ against
  8,805 m³ measured below it — **3,419 m³ (28.0%) unaccounted before any zone**,
  with daily figures swinging from 5.5% (day 5) to 63.8% (day 9). Reported, not
  explained: it could be trunk-main leakage, a main-bulk meter reading on a
  different basis, or a supply-side connection with no meter in the registry.
  Needs a physical check before anyone quotes the percentage.
