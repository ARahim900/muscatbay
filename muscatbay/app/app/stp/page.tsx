                                ...
                                <div className="h-[280px]">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart data={monthlyChartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                                            ...
                                            <Bar dataKey="savings" name="Savings" fill="#4E4456" radius={[6, 6, 0, 0]} animationDuration={800} />
                                        </BarChart>
                                    </ResponsiveContainer>
                                </div>
                            </CardContent>
                            ...
                            <table className="w-full text-sm border-collapse">
                                <thead>
                                    <tr className="bg-slate-50 dark:bg-slate-800/80 border-b border-slate-200 dark:border-slate-700">
                                        <th className="text-left py-2.5 px-3 font-semibold text-slate-600 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors" onClick={() => handleLogSort('date')}>
                                        ...
                                        <th className="text-right py-2.5 px-3 font-semibold text-slate-600 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors" onClick={() => handleLogSort('inlet')}>
                                        ...
                                        <th className="text-right py-2.5 px-3 font-semibold text-slate-600 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors" onClick={() => handleLogSort('tse')}>
                                        ...
                                        <th className="text-right py-2.5 px-3 font-semibold text-slate-600 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors" onClick={() => handleLogSort('efficiency')}>
                                        ...
                                        <th className="text-right py-2.5 px-3 font-semibold text-slate-600 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors" onClick={() => handleLogSort('trips')}>
                                        ...
                                        <th className="text-right py-2.5 px-3 font-semibold text-slate-600 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors" onClick={() => handleLogSort('income')}>
                                        ...
                                        <th className="text-right py-2.5 px-3 font-semibold text-slate-600 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors" onClick={() => handleLogSort('savings')}>
                                        ...
                                        <th className="text-right py-2.5 px-3 font-semibold text-slate-600 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors" onClick={() => handleLogSort('total')}>
                                ...
                                <tbody>
                                    {paginatedDailyOperations.map((op, idx) => {
                                        ...
                                        return (
                                            <tr key={op.id} className={`border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors ${idx % 2 === 0 ? 'bg-white dark:bg-slate-900/50' : 'bg-slate-50/30 dark:bg-slate-800/20'}`}>
                                                <td className="py-2 px-3 text-slate-600 dark:text-slate-400">{format(new Date(op.date), "dd/MM/yyyy")}</td>
                                                <td className="py-2 px-3 text-right font-mono text-xs text-primary font-medium">{op.inlet_sewage.toLocaleString()}</td>
                                                <td className="py-2 px-3 text-right font-mono text-xs text-blue-600 dark:text-blue-400 font-medium">{op.tse_for_irrigation.toLocaleString()}</td>
                                                <td className={`py-2 px-3 text-right font-mono text-xs font-medium ${efficiencyColor}`}>{efficiency.toFixed(1)}%</td>
                                                <td className="py-2 px-3 text-right font-mono text-xs text-amber-600 dark:text-amber-400">{op.tanker_trips}</td>
                                                <td className="py-2 px-3 text-right font-mono text-xs text-emerald-600 dark:text-emerald-400">{income.toFixed(2)}</td>
                                                <td className="py-2 px-3 text-right font-mono text-xs text-primary">{savings.toFixed(2)}</td>
                                                <td className="py-2 px-3 text-right font-mono text-xs font-semibold text-emerald-600 dark:text-emerald-400">{totalImpact.toFixed(2)}</td>
                                            </tr>
                                        );
                                    })}
