...
const AREA_CURSOR = { stroke: 'var(--chart-cursor-stroke)', strokeWidth: 2 } as const;
const BAR_CURSOR = { fill: 'var(--chart-cursor-fill)', radius: 4 } as const;
                ...
                >
                    <CardHeader className="card-elevated-header p-4 sm:p-5 md:p-6">
                        <CardTitle className="flex items-center gap-2 text-base @md:text-lg">
                            <Droplets className="h-5 w-5 text-mb-secondary-text" />
