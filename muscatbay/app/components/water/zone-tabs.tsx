            ...
            {zones.map((zone, index) => {
                ...
                return (
                    <button
                        ...
                        className={`px-3 sm:px-4 py-2.5 sm:py-2 rounded-lg text-sm font-medium transition-all duration-200 focus-visible:ring-2 focus-visible:ring-secondary/50 focus-visible:outline-none ${isSelected
