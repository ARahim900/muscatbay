                ...
                {options.map((option) => {
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                "px-3 py-1.5 text-xs font-medium rounded-md transition-all duration-200 focus-visible:ring-2 focus-visible:ring-secondary/50 focus-visible:outline-none",
                                isSelected
                                    ? colorStyle
