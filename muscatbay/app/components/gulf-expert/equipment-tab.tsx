        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filtered.map((e) => {
            ...
            return (
              <Card
                key={e.id}
                className={`bg-white dark:bg-slate-900 rounded-xl shadow-sm hover:shadow-md motion-safe:hover:-translate-y-0.5 transition-[transform,box-shadow] duration-200 ${
                  isNotOp
