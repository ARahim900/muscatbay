...
const AIRTABLE_API_KEY = process.env.AIRTABLE_API_KEY || 'patgswc3cLZkA2Yrv.eb7796293aaabbc988a0d68e9f34010e8baae51d02c669185971b55689885534'; // Your Airtable API key
const AIRTABLE_BASE_ID = process.env.AIRTABLE_BASE_ID || 'appwGy1JHL1UYsO2W'; // Your Airtable Base ID
