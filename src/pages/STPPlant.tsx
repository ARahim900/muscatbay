...
const STPPlant = () => {
            ...
            >
              ...
              <Tooltip 
                formatter={(value, name) => {
                  if (name === 'tankerVolume') return [`${value} m³`, 'Tanker Volume'];
                  if (name === 'directInlineSewage') return [`${value} m³`, 'Direct Inline'];
                  return [value, name];
                }}
  ...
  useEffect(() => {
    document.title = 'STP Plant Dashboard | Muscat Bay Asset Manager';
  }, []);
