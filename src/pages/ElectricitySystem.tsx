...
// Type for transformed month data
interface MonthData {
  month: string;
  total: number;
  cost?: number;
...
const electricityData: ElectricityDataItem[] = [
  ...
  { name: 'Actuator DB 01 (Z8)', account: 'R53196', type: 'DB', 'Apr-24': 39, 'May-24': 49, 'Jun-24': 43, 'Jul-24': 43, 'Aug-24': 45, 'Sep-24': 43, 'Oct-24': 36, 'Nov-24': 34, 'Dec-24': 29, 'Jan-24': 7, 'Feb-24': 28 },
  { name: 'Actuator DB 02', account: 'R51900', type: 'DB', 'Apr-24': 285, 'May-24': 335, 'Jun-24': 275, 'Jul-24': 220, 'Aug-24': 210, 'Sep-24': 219, 'Oct-24': 165, 'Nov-24': 232, 'Dec-24': 161, 'Jan-24': 33, 'Feb-24': 134 },
  { name: 'Actuator DB 03', account: 'R51904', type: 'DB', 'Apr-24': 188, 'May-24': 226, 'Jun-24': 197, 'Jul-24': 203, 'Aug-24': 212, 'Sep-24': 203, 'Oct-24': 196, 'Nov-24': 220, 'Dec-24': 199, 'Jan-24': 56, 'Feb-24': 203 },
  { name: 'Actuator DB 04', account: 'R51901', type: 'DB', 'Apr-24': 159, 'May-24': 275, 'Jun-24': 258, 'Jul-24': 210, 'Aug-24': 184, 'Sep-24': 201, 'Oct-24': 144, 'Nov-24': 172, 'Dec-24': 173, 'Jan-24': 186, 'Feb-24': 161 },
  { name: 'Actuator DB 05', account: 'R51907', type: 'DB', 'Apr-24': 15, 'May-24': 18, 'Jun-24': 15, 'Jul-24': 16, 'Aug-24': 16, 'Sep-24': 16, 'Oct-24': 15, 'Nov-24': 18, 'Dec-24': 16, 'Jan-24': 4, 'Feb-24': 18 },
  { name: 'Actuator DB 06', account: 'R51909', type: 'DB', 'Apr-24': 39, 'May-24': 50, 'Jun-24': 42, 'Jul-24': 48, 'Aug-24': 46, 'Sep-24': 129, 'Oct-24': 43, 'Nov-24': 49, 'Dec-24': 44, 'Jan-24': 47, 'Feb-24': 45 },
  { name: 'Street Light FP 01 (Z8)', account: 'R53197', type: 'Street Light', 'Apr-24': 2773, 'May-24': 3276, 'Jun-24': 3268, 'Jul-24': 3040, 'Aug-24': 3203, 'Sep-24': 3225, 'Oct-24': 3064, 'Nov-24': 3593, 'Dec-24': 3147, 'Jan-24': 787, 'Feb-24': 3228 },
  ...
  { name: 'Street Light FP 03', account: 'R51905', type: 'Street Light', 'Apr-24': 1399, 'May-24': 1608, 'Jun-24': 1365, 'Jul-24': 1380, 'Aug-24': 1457, 'Sep-24': 1499, 'Oct-24': 1561, 'Nov-24': 2060, 'Dec-24': 1966, 'Jan-24': 1868, 'Feb-24': 1974 },
  { name: 'Street Light FP 04', account: 'R51908', type: 'Street Light', 'Apr-24': 861, 'May-24': 1045, 'Jun-24': 1051, 'Jul-24': 2268, 'Aug-24': 2478, 'Sep-24': 2513, 'Oct-24': 2341, 'Nov-24': 2299, 'Dec-24': 1389, 'Jan-24': 325, 'Feb-24': 1406 },
  { name: 'Street Light FP 05', account: 'R51902', type: 'Street Light', 'Apr-24': 532, 'May-24': 587, 'Jun-24': 575, 'Jul-24': 770, 'Aug-24': 1341, 'Sep-24': 1895, 'Oct-24': 1844, 'Nov-24': 1477, 'Dec-24': 1121, 'Jan-24': 449, 'Feb-24': 2070 },
  ...
  { name: 'Helipad', account: 'R52334', type: 'D_Building', 'Apr-24': 0, 'May-24': 0, 'Jun-24': 0, 'Jul-24': 0, 'Aug-24': 0, 'Sep-24': 0, 'Oct-24': 0, 'Nov-24': 0, 'Dec-24': 0, 'Jan-24': 0, 'Feb-24': 0 },
  ...
  { name: 'Guard House', account: 'R53651', type: 'D_Building', 'Apr-24': 823, 'May-24': 1489, 'Jun-24': 1574, 'Jul-24': 1586, 'Aug-24': 1325, 'Sep-24': 1391, 'Oct-24': 1205, 'Nov-24': 1225, 'Dec-24': 814, 'Jan-24': 798, 'Feb-24': 936 },
  { name: 'Security Building', account: 'R53649', type: 'D_Building', 'Apr-24': 3529, 'May-24': 3898, 'Jun-24': 4255, 'Jul-24': 4359, 'Aug-24': 3728, 'Sep-24': 3676, 'Oct-24': 3140, 'Nov-24': 5702, 'Dec-24': 5131, 'Jan-24': 5559, 'Feb-24': 5417 },
  { name: 'ROP Building', account: 'R53648', type: 'D_Building', 'Apr-24': 2047, 'May-24': 4442, 'Jun-24': 3057, 'Jul-24': 4321, 'Aug-24': 4185, 'Sep-24': 3554, 'Oct-24': 3692, 'Nov-24': 3581, 'Dec-24': 2352, 'Jan-24': 2090, 'Feb-24': 2246 },
  { name: 'D Building 44', account: 'R53705', type: 'D_Building', 'Apr-24': 463, 'May-24': 2416, 'Jun-24': 2036, 'Jul-24': 2120, 'Aug-24': 1645, 'Sep-24': 1717, 'Oct-24': 1643, 'Nov-24': 1377, 'Dec-24': 764, 'Jan-24': 647, 'Feb-24': 657 },
  { name: 'Bank muscat', account: '', type: 'Retail', 'Apr-24': 0, 'May-24': 0, 'Jun-24': 0, 'Jul-24': 3, 'Aug-24': 71, 'Sep-24': -2, 'Oct-24': 1407, 'Nov-24': 148, 'Dec-24': 72, 'Jan-24': 59, 'Feb-24': 98 },
  { name: 'CIF kitchen', account: '', type: 'Retail', 'Apr-24': 0, 'May-24': 0, 'Jun-24': 0, 'Jul-24': 17895, 'Aug-24': 16532, 'Sep-24': 18955, 'Oct-24': 15071, 'Nov-24': 16742, 'Dec-24': 15554, 'Jan-24': 16788, 'Feb-24': 16154 }
];

// Extract unique years from the data
const years = [...new Set([2024])]; // Assuming all data is from 2024

// Map month indexes to month names for better reference
const monthMapping: Record<string, number> = {
  'Apr-24': 0, 'May-24': 1, 'Jun-24': 2, 'Jul-24': 3, 'Aug-24': 4, 'Sep-24': 5,
  'Oct-24': 6, 'Nov-24': 7, 'Dec-24': 8, 'Jan-24': 9, 'Feb-24': 10
};
...
const transformedData: MonthData[] = monthNames.map(month => {
  ...
  monthData.total = facilityTypes.reduce((sum, type) => {
    const typeValue = monthData[type];
    return sum + (typeof typeValue === 'number' ? typeValue : 0);
  }, 0);
  
  return monthData;
});

// Main theme color - Purple/Mauve
const THEME_COLOR = '#4E4456';
...
const ElectricitySystem = () => {
  ...
  useEffect(() => {
    ...
    if (selectedYear !== 'all') {
      // In this example, all data is from the same year, so no filtering is needed
      // But in a real application, you would filter by year here
    }
  ...
  const metrics = useMemo<MetricsType>(() => {
    ...
    facilityTypes.forEach(type => {
      consumptionByType[type] = filteredData.reduce((sum, month) => {
  ...
  const activeTabBg = darkMode ? 'bg-gray-700' : 'bg-purple-50';
  const activeTabText = darkMode ? 'text-purple-400' : 'text-purple-600';
  const headerBg = darkMode ? 'bg-gray-800' : 'bg-white';

  // Define tabs for the dashboard
  const tabs = [
    { id: 'overview', label: 'Overview', icon: <TrendingUp size={16} /> },
    { id: 'consumption', label: 'Consumption Analysis', icon: <BarChart2 size={16} /> },
    { id: 'facilities', label: 'Facility Types', icon: <Activity size={16} /> },
  ...
  return (
    <Layout>
      <div className={`min-h-screen ${bgColor} ${textColor}`}>
        {/* Header */}
        <div className={`${headerBg} border-b ${borderColor} p-4 flex justify-between items-center mb-4 rounded-lg shadow-sm`}>
          <div className="flex items-center">
            <div className="flex items-center justify-center p-2 w-10 h-10 rounded text-white mr-3" style={{ backgroundColor: THEME_COLOR }}>
              <Zap size={20} />
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="px-3 py-2 text-white rounded-md flex items-center bg-[71657c]"
        ...
        <div className="overflow-y-auto">
          ...
          <div className="mb-6">
            <h2 className="text-xl font-semibold">
              Showing: <span style={{ color: THEME_COLOR }}>{getDisplayText()}</span>
            </h2>
          </div>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div className={`${cardBg} p-6 rounded-lg border ${borderColor} shadow-sm hover:shadow-md transition-shadow duration-300`}>
                  ...
                  <div className="mt-2">
                    <div className="text-3xl font-bold" style={{ color: THEME_COLOR }}>{formatCurrency(metrics.totalConsumption)}</div>
                ...
                <div className="flex flex-wrap gap-2">
                  {facilityTypes.map(type => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm flex items-center transition-colors duration-200`}
                      style={{ 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                {Object.entries(metrics.consumptionByType || {})
                  ...
                  .map(([type, consumption]) => (
                    <div 
                      key={type} 
                      className={`${cardBg} p-6 rounded-lg border ${borderColor} shadow-sm hover:shadow-md transition-shadow duration-300`}
                      style={{ borderLeftColor: typeColors[type], borderLeftWidth: '4px' }}
                    >
                      <h3 className={secondaryText}>{type}</h3>
                      <div className="mt-2">
                        <div className="text-3xl font-bold" style={{ color: typeColors[type] }}>{formatNumber(consumption)}</div>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                      {electricityData
                        .map(facility => {
                          const totalConsumption = monthNames.reduce((sum, month) => {
                            const monthValue = facility[month];
                            return sum + (typeof monthValue === 'number' ? monthValue : 0);
                          }, 0);
                          return {
                            ...facility,
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-400">
                              ...
                              >
                                <span 
                                  ...
                                  style={{ backgroundColor: typeColors[facility.type] }}
                                ></span>
                                {facility.type}
                              </span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                              {formatNumber(facility.totalConsumption)}
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                              {formatCurrency(facility.totalConsumption)}
                            </td>
                          </tr>
                        ))
                      }
          ...
          {activeTab === 'facilities' && (
            <>
                ...
                {facilityTypes.map(type => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <h3 className="font-medium" style={{ color: typeColors[type] }}>{type}</h3>
                      <span 
                    ...
                    <div className="mt-2">
                      <div className="text-lg font-semibold" style={{ color: THEME_COLOR }}>{formatCurrency(metrics.consumptionByType[type])}</div>
              ...
              {facilityTypes.map(type => (
                <div key={type} className={`${cardBg} p-6 rounded-lg border ${borderColor} mb-6 shadow-sm`}>
                  <h2 className="text-xl font-medium mb-4" style={{ color: typeColors[type] }}>{type} Facilities</h2>
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50 dark:bg-gray-700">
                        <tr>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div className={`${cardBg} p-6 rounded-lg border ${borderColor} shadow-sm hover:shadow-md transition-shadow duration-300`}>
                  ...
                  <div className="mt-2">
                    <div className="text-3xl font-bold" style={{ color: THEME_COLOR }}>{formatCurrency(metrics.averageMonthlyConsumption)}</div>
                ...
                <div className={`${cardBg} p-6 rounded-lg border ${borderColor} shadow-sm hover:shadow-md transition-shadow duration-300`}>
                  ...
                  <div className="mt-2">
                    {(() => {
                      ...
                      return (
                        <>
                          <div className="text-3xl font-bold" style={{ color: THEME_COLOR }}>{formatCurrency(highestCostFacility.consumption)}</div>
                  ...
                  <div className="mt-2">
                    <div className="text-xl font-semibold">
                      {Object.entries(metrics.consumptionByType || {})
                        ...
                        .slice(0, 1)
                        .map(([type, consumption]) => (
                          <div key={type} className="text-gray-800">
                            <span 
                            ...
                            <span style={{ color: THEME_COLOR }}>{formatCurrency(consumption)}</span>
                          </div>
                        ))
                      }
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className={`${cardBg} p-6 rounded-lg border ${borderColor} shadow-sm`}>
                  ...
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart
                        data={consumptionByTypeData.map(type => ({
                          ...type,
                      ...
                      {electricityData
                        ...
                        .map((facility, index) => (
                          <tr key={index} className={index % 2 === 0 ? '' : 'bg-gray-50 dark:bg-gray-700'}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">{formatNumber(facility.totalConsumption)}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium" style={{ color: THEME_COLOR }}>{formatCurrency(facility.totalConsumption)}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
