...
const ElectricitySystem = () => {
  ...
  const formatCurrency = (num) => {
    ...
    return `${(num * COST_PER_KWH).toLocaleString(undefined, { minimumFractionDigits: 3, maximumFractionDigits: 3 })} OMR`;
  };
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="px-3 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-md flex items-center"
              >
                  ...
                  <div className="mt-2">
                    <div className="text-xl font-semibold">
                      {Object.entries(metrics.consumptionByType || {})
                        ...
                        .slice(0, 1)
                        .map(([type, consumption]) => (
                          <div key={type} style={{ color: typeColors[type] }}>
