  ...
  return <div className="container mx-auto p-4">
      <div className="flex flex-col gap-6">
        <div className="text-center my-8">
          <h1 className="text-3xl font-bold mb-2 text-muscat-primary">Muscat Bay Management Portal</h1>
          <p className="text-muscat-dark">Welcome to the Muscat Bay property management and utilities dashboard</p>
        </div>
