    ...
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold">Financial Visualizer</h1>
        </div>
      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <div className="mb-4">
          <p className="text-sm text-muted-foreground">
            Showing: <span className="font-medium">Financial Data for {selectedYear}</span>
          </p>
        </div>
          ...
          <Card className="border-0 shadow-sm">
            <CardContent className="p-0 h-[calc(100vh-260px)] min-h-[500px] relative">
              ...
              <iframe 
                ...
                className="w-full h-full rounded-md"
                onLoad={handleIframeLoad}
                title="Financial Visualizer - Detailed"
                style={{ border: 'none' }}
                sandbox="allow-scripts allow-same-origin allow-forms allow-popups"
              />
            </CardContent>
          ...
          <Card className="border-0 shadow-sm">
            <CardContent className="p-0 h-[calc(100vh-260px)] min-h-[500px] relative">
              ...
              <iframe 
                ...
                className="w-full h-full rounded-md"
                onLoad={handleIframeLoad}
                title="Financial Visualizer - Forecast"
                style={{ border: 'none' }}
                sandbox="allow-scripts allow-same-origin allow-forms allow-popups"
              />
            </CardContent>
