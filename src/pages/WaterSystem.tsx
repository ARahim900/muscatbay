...
const actualData = {
  // Monthly metrics
  monthlyMetrics: {
    'Jan-25': { L1: 32580, L2: 35224, L3: 7900, DC: 19897 },
    'Feb-25': { L1: 44043, L2: 36054, L3: 7274, DC: 21338 },
    'Mar-25': { L1: 34915, L2: 11826, L3: 2118, DC: 7726 },
    'Total': { L1: 111538, L2: 83104, L3: 17292, DC: 48961 }
  },
  ...
  zoneMetrics: {
    'Zone_01_(FM)': {
      'Jan-25': { L2: 2008, L3: 2062, loss: -54, lossPercent: -2.69 },
      'Feb-25': { L2: 1740, L3: 1832, loss: -92, lossPercent: -5.29 },
      'Mar-25': { L2: 561, L3: 546, loss: 15, lossPercent: 2.67 },
      'Total': { L2: 4309, L3: 4440, loss: -131, lossPercent: -3.04 }
    },
    'Zone_03_(A)': {
      'Jan-25': { L2: 4235, L3: 1359, loss: 2876, lossPercent: 67.91 },
      'Feb-25': { L2: 4273, L3: 1349, loss: 2924, lossPercent: 68.43 },
      'Mar-25': { L2: 985, L3: 365, loss: 620, lossPercent: 62.94 },
      'Total': { L2: 9493, L3: 3073, loss: 6420, lossPercent: 67.63 }
    },
    'Zone_03_(B)': {
      'Jan-25': { L2: 3256, L3: 1713, loss: 1543, lossPercent: 47.39 },
      'Feb-25': { L2: 2962, L3: 1451, loss: 1511, lossPercent: 51.01 },
      'Mar-25': { L2: 699, L3: 336, loss: 363, lossPercent: 51.93 },
      'Total': { L2: 6917, L3: 3500, loss: 3417, lossPercent: 49.40 }
    },
    'Zone_05': {
      'Jan-25': { L2: 4267, L3: 1254, loss: 3013, lossPercent: 70.61 },
      'Feb-25': { L2: 4231, L3: 1233, loss: 2998, lossPercent: 70.86 },
      'Mar-25': { L2: 1243, L3: 294, loss: 949, lossPercent: 76.35 },
      'Total': { L2: 9741, L3: 2781, loss: 6960, lossPercent: 71.45 }
    },
    'Zone_08': {
      'Jan-25': { L2: 1547, L3: 1477, loss: 70, lossPercent: 4.52 },
      'Feb-25': { L2: 1498, L3: 1379, loss: 119, lossPercent: 7.94 },
      'Mar-25': { L2: 609, L3: 563, loss: 46, lossPercent: 7.55 },
      'Total': { L2: 3654, L3: 3419, loss: 235, lossPercent: 6.43 }
    },
    'Zone_VS': {
      'Jan-25': { L2: 14, L3: 35, loss: -21, lossPercent: -150.00 },
      'Feb-25': { L2: 12, L3: 28, loss: -16, lossPercent: -133.33 },
      'Mar-25': { L2: 3, L3: 13, loss: -10, lossPercent: -333.33 },
      'Total': { L2: 29, L3: 76, loss: -47, lossPercent: -162.07 }
    }
  },

  // Type consumption breakdown
  typeBreakdown: [
    { type: 'Retail', value: 52354, percentage: 79.02, color: '#3182CE' },
    { type: 'Residential (Villa)', value: 9912, percentage: 14.96, color: '#63B3ED' },
    { type: 'Residential (Apart)', value: 2712, percentage: 4.09, color: '#90CDF4' },
    { type: 'IRR_Servies', value: 585, percentage: 0.88, color: '#BEE3F8' },
    { type: 'MB_Common', value: 353, percentage: 0.53, color: '#EBF8FF' },
    { type: 'Building', value: 143, percentage: 0.22, color: '#4299E1' },
    { type: 'D_Building_Common', value: 38, percentage: 0.06, color: '#E2E8F0' }
  ],
  
  // Detailed consumer data by zone (sample data based on screenshots)
  consumerDetails: {
    'Zone_01_(FM)': [
      { acctNum: '4300298', meterLabel: 'Building Taxi', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 31, type: 'Retail' },
      { acctNum: '4300300', meterLabel: 'Building B1', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 523, type: 'Retail' },
      { acctNum: '4300301', meterLabel: 'Building B2', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 511, type: 'Retail' },
      { acctNum: '4300302', meterLabel: 'Building B3', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 373, type: 'Retail' },
      { acctNum: '4300303', meterLabel: 'Building B4', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 255, type: 'Retail' },
      { acctNum: '4300304', meterLabel: 'Building B5', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 3, type: 'Retail' },
      { acctNum: '4300305', meterLabel: 'Building B6', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 576, type: 'Retail' },
      { acctNum: '4300306', meterLabel: 'Building B7', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 421, type: 'Retail' },
      { acctNum: '4300307', meterLabel: 'Building B8', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 586, type: 'Retail' },
      { acctNum: '4300324', meterLabel: 'Building CIF/CB', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 841, type: 'Retail' },
      { acctNum: '4300325', meterLabel: 'Building Nursery Building', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 10, type: 'Retail' },
      { acctNum: '4300337', meterLabel: 'Cabinet FM (CONTRACTORS OFFICE)', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 143, type: 'Building' },
      { acctNum: '4300296', meterLabel: 'Building FM', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 84, type: 'MB_Common' },
      { acctNum: '4300309', meterLabel: 'Room PUMP (FIRE)', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 78, type: 'MB_Common' },
      { acctNum: '4300310', meterLabel: 'Building (MEP)', parent: 'ZONE FM ( BULK ZONE FM )', consumption: 5, type: 'MB_Common' }
    ],
    'Zone_03_(A)': [
      { acctNum: '4300002', meterLabel: 'Z3-42 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 82, type: 'Residential (Villa)' },
      { acctNum: '4300005', meterLabel: 'Z3-38 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 19, type: 'Residential (Villa)' },
      { acctNum: '4300007', meterLabel: 'Z3-46(3A) (Building)', parent: 'D-46 Building Bulk Meter', consumption: 78, type: 'Residential (Apart)' },
      { acctNum: '4300010', meterLabel: 'Z3-049(4) (Building)', parent: 'D-49 Building Bulk Meter', consumption: 13, type: 'Residential (Apart)' },
      { acctNum: '4300034', meterLabel: 'Z3-44(5) (Building)', parent: 'D-44 Building Bulk Meter', consumption: 288, type: 'Residential (Apart)' },
      { acctNum: '4300035', meterLabel: 'Z3-44(6) (Building)', parent: 'D-44 Building Bulk Meter', consumption: 79, type: 'Residential (Apart)' },
      { acctNum: '4300044', meterLabel: 'Z3-41 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 37, type: 'Residential (Villa)' },
      { acctNum: '4300049', meterLabel: 'Z3-37 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 42, type: 'Residential (Villa)' },
      { acctNum: '4300050', meterLabel: 'Z3-43 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 154, type: 'Residential (Villa)' },
      { acctNum: '4300052', meterLabel: 'Z3-31 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 328, type: 'Residential (Villa)' },
      { acctNum: '4300075', meterLabel: 'Z3-35 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 140, type: 'Residential (Villa)' },
      { acctNum: '4300082', meterLabel: 'Z3-33 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 101, type: 'Residential (Villa)' },
      { acctNum: '4300084', meterLabel: 'Z3-36 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 184, type: 'Residential (Villa)' },
      { acctNum: '4300085', meterLabel: 'Z3-32 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 86, type: 'Residential (Villa)' },
      { acctNum: '4300086', meterLabel: 'Z3-39 (Villa)', parent: 'ZONE 3A (BULK ZONE 3A)', consumption: 83, type: 'Residential (Villa)' }
    ],
    'Zone_05': [
      { acctNum: '4300001', meterLabel: 'Z5-17', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 219, type: 'Residential (Villa)' },
      { acctNum: '4300058', meterLabel: 'Z5-13', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 206, type: 'Residential (Villa)' },
      { acctNum: '4300059', meterLabel: 'Z5-14', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 164, type: 'Residential (Villa)' },
      { acctNum: '4300147', meterLabel: 'Z5-30', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 178, type: 'Residential (Villa)' },
      { acctNum: '4300149', meterLabel: 'Z5-10', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 37, type: 'Residential (Villa)' },
      { acctNum: '4300150', meterLabel: 'Z5-4', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 184, type: 'Residential (Villa)' },
      { acctNum: '4300152', meterLabel: 'Z5 020', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 95, type: 'Residential (Villa)' },
      { acctNum: '4300154', meterLabel: 'Z5-15', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 59, type: 'Residential (Villa)' },
      { acctNum: '4300155', meterLabel: 'Z5-9', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 100, type: 'Residential (Villa)' },
      { acctNum: '4300156', meterLabel: 'Z5-26', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 105, type: 'Residential (Villa)' },
      { acctNum: '4300157', meterLabel: 'Z5-25', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 63, type: 'Residential (Villa)' },
      { acctNum: '4300158', meterLabel: 'Z5-31', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 61, type: 'Residential (Villa)' },
      { acctNum: '4300160', meterLabel: 'Z5-29', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 120, type: 'Residential (Villa)' },
      { acctNum: '4300162', meterLabel: 'Z5-32', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 199, type: 'Residential (Villa)' },
      { acctNum: '4300163', meterLabel: 'Z5-22', parent: 'ZONE 5 (Bulk Zone 5)', consumption: 104, type: 'Residential (Villa)' }
    ],
    'Zone_08': [
      { acctNum: '4300196', meterLabel: 'Z8-12', parent: 'BULK ZONE 8', consumption: 509, type: 'Residential (Villa)' },
      { acctNum: '4300198', meterLabel: 'Z8-15', parent: 'BULK ZONE 8', consumption: 182, type: 'Residential (Villa)' },
      { acctNum: '4300199', meterLabel: 'Z8-16', parent: 'BULK ZONE 8', consumption: 161, type: 'Residential (Villa)' },
      { acctNum: '4300200', meterLabel: 'Z8-17', parent: 'BULK ZONE 8', consumption: 380, type: 'Residential (Villa)' },
      { acctNum: '4300287', meterLabel: 'Z8-5', parent: 'BULK ZONE 8', consumption: 643, type: 'Residential (Villa)' },
      { acctNum: '4300288', meterLabel: 'Z8-9', parent: 'BULK ZONE 8', consumption: 20, type: 'Residential (Villa)' },
      { acctNum: '4300289', meterLabel: 'Z8-18', parent: 'BULK ZONE 8', consumption: 291, type: 'Residential (Villa)' },
      { acctNum: '4300290', meterLabel: 'Z8-19', parent: 'BULK ZONE 8', consumption: 235, type: 'Residential (Villa)' },
      { acctNum: '4300291', meterLabel: 'Z8-20', parent: 'BULK ZONE 8', consumption: 335, type: 'Residential (Villa)' },
      { acctNum: '4300292', meterLabel: 'Z8-21', parent: 'BULK ZONE 8', consumption: 217, type: 'Residential (Villa)' },
      { acctNum: '4300293', meterLabel: 'Z8-22', parent: 'BULK ZONE 8', consumption: 441, type: 'Residential (Villa)' }
    ],
    'Zone_03_(B)': [
      { acctNum: '4300009', meterLabel: 'Z3-21 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 105, type: 'Residential (Villa)' },
      { acctNum: '4300020', meterLabel: 'Z3-20 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 29, type: 'Residential (Villa)' },
      { acctNum: '4300025', meterLabel: 'Z3-13 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 46, type: 'Residential (Villa)' },
      { acctNum: '4300057', meterLabel: 'Z3-15 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 91, type: 'Residential (Villa)' },
      { acctNum: '4300060', meterLabel: 'Z3-14 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 274, type: 'Residential (Villa)' },
      { acctNum: '4300076', meterLabel: 'Z3-12 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 145, type: 'Residential (Villa)' },
      { acctNum: '4300078', meterLabel: 'Z3-4 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 161, type: 'Residential (Villa)' },
      { acctNum: '4300083', meterLabel: 'Z3-18 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 80, type: 'Residential (Villa)' },
      { acctNum: '4300088', meterLabel: 'Z3-3 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 139, type: 'Residential (Villa)' },
      { acctNum: '4300090', meterLabel: 'Z3-7 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 96, type: 'Residential (Villa)' },
      { acctNum: '4300092', meterLabel: 'Z3-10 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 175, type: 'Residential (Villa)' },
      { acctNum: '4300096', meterLabel: 'Z3-9 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 129, type: 'Residential (Villa)' },
      { acctNum: '4300099', meterLabel: 'Z3-19 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 145, type: 'Residential (Villa)' },
      { acctNum: '4300100', meterLabel: 'Z3-6 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 69, type: 'Residential (Villa)' },
      { acctNum: '4300102', meterLabel: 'Z3-22 (Villa)', parent: 'ZONE 3B (BULK ZONE 3B)', consumption: 62, type: 'Residential (Villa)' }
    ],
    'Zone_VS': [
      { acctNum: '4300327', meterLabel: 'Coffee 1 (GF Shop No.591)', parent: 'Village Square (Zone Bulk)', consumption: 3, type: 'Retail' },
      { acctNum: '4300329', meterLabel: 'Coffee 2 (GF Shop No.594 A)', parent: 'Village Square (Zone Bulk)', consumption: 7, type: 'Retail' },
      { acctNum: '4300330', meterLabel: 'Supermarket (FF Shop No.591)', parent: 'Village Square (Zone Bulk)', consumption: 0, type: 'Retail' },
      { acctNum: '4300331', meterLabel: 'Pharmacy (FF Shop No.591 A)', parent: 'Village Square (Zone Bulk)', consumption: 0, type: 'Retail' },
      { acctNum: '4300332', meterLabel: 'Laundry Services (FF Shop No.593)', parent: 'Village Square (Zone Bulk)', consumption: 66, type: 'Retail' }
    ],
    'Direct Connection': [
      { acctNum: '4300295', meterLabel: 'Sales Center Common Building', parent: 'Main Bulk (NAMA)', consumption: 156, type: 'Zone Bulk' },
      { acctNum: '4300297', meterLabel: 'Building (Security)', parent: 'Main Bulk (NAMA)', consumption: 39, type: 'MB_Common' },
      { acctNum: '4300299', meterLabel: 'Building (ROP)', parent: 'Main Bulk (NAMA)', consumption: 52, type: 'MB_Common' },
      { acctNum: '4300334', meterLabel: 'Hotel Main Building', parent: 'Main Bulk (NAMA)', consumption: 44384, type: 'Retail' },
      { acctNum: '4300336', meterLabel: 'Community Mgmt - Technical Zone, STP', parent: 'Main Bulk (NAMA)', consumption: 74, type: 'MB_Common' },
      { acctNum: '4300338', meterLabel: 'PHASE 02, MAIN ENTRANCE (Infrastructure)', parent: 'Main Bulk (NAMA)', consumption: 21, type: 'MB_Common' },
      { acctNum: '4300341', meterLabel: 'Irrigation- Controller DOWN', parent: 'Main Bulk (NAMA)', consumption: 474, type: 'IRR_Servies' },
      { acctNum: '4300347', meterLabel: 'Al Adrak Construction', parent: 'Main Bulk (NAMA)', consumption: 2099, type: 'Retail' },
      { acctNum: '4300348', meterLabel: 'Al Adrak Camp', parent: 'Main Bulk (NAMA)', consumption: 1662, type: 'Retail' }
    ]
  },
  
  parentMeters: {
    'ZONE FM ( BULK ZONE FM )': { acctNum: '4300346', zone: 'Zone_01_(FM)', label: 'L2' },
    'ZONE 3A (BULK ZONE 3A)': { acctNum: '4300343', zone: 'Zone_03_(A)', label: 'L2' },
    'ZONE 3B (BULK ZONE 3B)': { acctNum: '4300344', zone: 'Zone_03_(B)', label: 'L2' },
    'ZONE 5 (Bulk Zone 5)': { acctNum: '4300345', zone: 'Zone_05', label: 'L2' },
    'BULK ZONE 8': { acctNum: '4300342', zone: 'Zone_08', label: 'L2' },
    'Village Square (Zone Bulk)': { acctNum: '4300335', zone: 'Zone_VS', label: 'L2' },
    'Main Bulk (NAMA)': { acctNum: 'C43659', zone: 'Main Bulk', label: 'L1' },
    'D-46 Building Bulk Meter': { acctNum: '4300138', zone: 'Zone_03_(A)', label: 'L3' },
    'D-49 Building Bulk Meter': { acctNum: '4300140', zone: 'Zone_03_(A)', label: 'L3' },
    'D-44 Building Bulk Meter': { acctNum: '4300144', zone: 'Zone_03_(A)', label: 'L3' }
  }
};
...
const GaugeChart = ({ value, max, label, color, percentage, size = 'large' }) => {
      ...
      <div className="relative">
        <svg width={radius * 2 + strokeWidth} height={radius * 2 + strokeWidth} viewBox={`0 0 ${radius * 2 + strokeWidth} ${radius * 2 + strokeWidth}`}>
          ...
          <circle
            ...
            strokeDashoffset={2 * Math.PI * radius * (1 - Math.min(1, value / max))}
            strokeLinecap="round"
...
const Dashboard = () => {
  ...
  const currentData = useMemo(() => {
    ...
    const monthlyData = Object.keys(actualData.monthlyMetrics)
    ...
    const topLossZones = Object.entries(actualData.zoneMetrics)
      .map(([zone, metrics]) => ({
        zone,
      ...
      .filter(zone => zone.lossPercent > 0); // Only show zones with positive loss
  ...
  const filteredConsumerDetails = useMemo(() => {
    ...
    const filtered = currentData.consumerDetails[selectedZone]
      .filter(item => 
        item.meterLabel.toLowerCase().includes(searchTerm.toLowerCase()) ||
        item.acctNum.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const AnimatedValue = ({ value, formatter, className }) => {
  ...
  // KPI Card Component
  const KpiCard = ({ title, value, formatter, color, icon, trend }) => {
    return (
      <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
        <div className="px-4 py-5 sm:p-6">
          <div className="flex items-center">
            <div className="flex-shrink-0 bg-opacity-20 rounded-md p-3" style={{ backgroundColor: `${color}20` }}>
        ...
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              <select 
                className="bg-white bg-opacity-20 rounded border border-blue-300 text-white px-3 py-1"
                  ...
                  >
                    ...
                    <Tooltip 
                      ...
                      formatter={(value, name) => [
                        name === 'loss' ? `${formatNumber(value)} m³` : `${value.toFixed(2)}%`,
                        name === 'loss' ? 'Loss Volume' : 'Loss Percentage'
                      ]}
                    />
                    <Legend />
            ...
            <div className="bg-white rounded-xl shadow-md p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="flex justify-center">
                  <GaugeChart 
                    value={currentData.zoneDetails[selectedZone].l2Reading}
                    max={Math.max(currentData.zoneDetails[selectedZone].l2Reading, currentData.zoneDetails[selectedZone].l3Sum) * 1.2}
                ...
                <div className="flex justify-center">
                  <GaugeChart 
                    value={currentData.zoneDetails[selectedZone].l3Sum}
                    max={Math.max(currentData.zoneDetails[selectedZone].l2Reading, currentData.zoneDetails[selectedZone].l3Sum) * 1.2}
                ...
                <div className="flex justify-center">
                  <GaugeChart 
                    value={Math.abs(currentData.zoneDetails[selectedZone].loss)}
                    max={Math.max(Math.abs(currentData.zoneDetails[selectedZone].loss), 1000)}
                    label={currentData.zoneDetails[selectedZone].loss < 0 ? "Surplus Volume" : "Loss Volume"}
                    color={currentData.zoneDetails[selectedZone].loss < 0 ? COLORS.success : COLORS.danger}
                  />
                </div>
                <div className="flex justify-center">
                  <GaugeChart 
                    value={Math.abs(currentData.zoneDetails[selectedZone].lossPercent)}
                    max={100}
                    label={currentData.zoneDetails[selectedZone].lossPercent < 0 ? "Surplus Percentage" : "Loss Percentage"}
                    color={currentData.zoneDetails[selectedZone].lossPercent < 0 ? COLORS.success : COLORS.danger}
                    percentage={true}
                  />
                </div>
              </div>
              ...
              <div className="overflow-x-auto mt-4">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      <th 
                        ...
                        onClick={() => requestSort('acctNum')}
                      >
                        Account #
                        {sortConfig.key === 'acctNum' && (
                      ...
                      <th 
                        scope="col" 
                        className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100"
                        onClick={() => requestSort('meterLabel')}
                      >
                        Meter Label
                        {sortConfig.key === 'meterLabel' && (
                          <span className="ml-1">{sortConfig.direction === 'asc' ? '↑' : '↓'}</span>
                        )}
                      </th>
                      <th 
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredConsumerDetails.map((item, index) => (
                      <tr key={item.acctNum} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <button 
                            ...
                            onClick={() => setShowParentDetails(item.parent)}
                          >
                            {item.parent}
                          </button>
                        </td>
              ...
              {showParentDetails && (
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50">
                  <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 md:mx-auto">
                    ...
                    <div className="p-6">
                      {/* Parent details */}
                      {actualData.parentMeters[showParentDetails] && (
                      ...
                      {consumersByParent[showParentDetails] && consumersByParent[showParentDetails].length > 0 ? (
                        <div className="overflow-x-auto">
                          <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                              {consumersByParent[showParentDetails].map((child) => (
                        ...
                        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                          <div className="flex justify-between">
                            ...
                            <p className="font-bold text-gray-900">
                              {formatNumber(
                                consumersByParent[showParentDetails].reduce(
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {Object.entries(currentData.zoneDetails)
                      .sort((a, b) => b[1].lossPercent - a[1].lossPercent)
                      .map(([zone, data]) => (
...
const WaterSystem = () => {
  return (
    <StandardPageLayout
      title="Water System"
      description="Management and monitoring of water distribution across Muscat Bay"
      icon={<Droplets className="h-6 w-6 text-blue-500" />}
      headerColor="bg-gradient-to-r from-blue-100 to-cyan-50"
    >
      <Dashboard />
    </StandardPageLayout>
  );
