          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-xs text-gray-500 mt-2">* The trend shows increasing direct sewage contribution over time</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <h3 className="text-sm font-semibold mb-4" style={{ color: colors.primary }}>Treatment & Recovery Efficiency</h3>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data}>
                      <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
                      ...
                      <Line 
                        ...
                        dot={{ stroke: colors.chart4, strokeWidth: 2, r: 4 }}
                        unit="%"
                      />
                      <Line 
                        type="monotone" 
                        ...
                        dot={{ stroke: colors.chart5, strokeWidth: 2, r: 4 }}
                        unit="%"
                      />
                      <Line 
                        type="monotone" 
                        dataKey={() => 85} 
                        name="Minimum Efficiency Target" 
                        stroke="red" 
                        strokeDasharray="5 5"
                        dot={false}
                        unit="%"
                ...
                <p className="text-xs text-gray-500 mt-2">* Treatment efficiency target: minimum 85%. Water recovery consistently above 100% indicates possible meter calibration issues.</p>
              </div>
              
              {/* Volume Comparison */}
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <h3 className="text-sm font-semibold mb-4" style={{ color: colors.primary }}>Monthly Volume Comparison</h3>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data} maxBarSize={40}>
                      ...
                      />
                      <YAxis 
                        label={{ value: 'Volume (m³)', angle: -90, position: 'insideLeft', style: { textAnchor: 'middle', fontSize: '12px', fill: '#666' } }} 
                        tick={{ fontSize: 12 }}
                      />
                      <Tooltip content={<CustomTooltip />} />
                      <Legend wrapperStyle={{ fontSize: '12px' }} />
                ...
                <p className="text-xs text-gray-500 mt-2">* Processed water consistently exceeds influent volume, indicating potential measurement discrepancies.</p>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'performance' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <h3 className="text-sm font-semibold mb-3" style={{ color: colors.primary }}>Treatment Efficiency</h3>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-3xl font-bold" style={{ color: colors.chart4 }}>{metrics.avgTreatmentEfficiency.toFixed(1)}%</p>
                    <p className="text-xs text-gray-500 mt-1">Average across selected period</p>
                  </div>
                  <div>
                    {metrics.avgTreatmentEfficiency >= 88 ? (
                      <div className="bg-green-100 text-green-800 text-xs font-medium py-1 px-2 rounded">Excellent</div>
                    ) : metrics.avgTreatmentEfficiency >= 85 ? (
                      <div className="bg-blue-100 text-blue-800 text-xs font-medium py-1 px-2 rounded">Good</div>
                    ) : (
                      <div className="bg-yellow-100 text-yellow-800 text-xs font-medium py-1 px-2 rounded">Acceptable</div>
                    )}
                  </div>
                </div>
                ...
                <div className="mt-4 h-8 bg-gray-200 rounded-full overflow-hidden">
                  <div 
                    ...
                    style={{ 
                      width: `${Math.min(metrics.avgTreatmentEfficiency, 100)}%`, 
                      backgroundColor: metrics.avgTreatmentEfficiency >= 88 ? colors.success : 
                                      metrics.avgTreatmentEfficiency >= 85 ? colors.chart5 : 
                                      colors.warning 
                    }}
                  ></div>
                </div>
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <h3 className="text-sm font-semibold mb-3" style={{ color: colors.primary }}>Capacity Utilization</h3>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-3xl font-bold" style={{ color: colors.chart1 }}>{metrics.avgCapacityUtilization.toFixed(1)}%</p>
                    <p className="text-xs text-gray-500 mt-1">of 750 m³/day maximum</p>
                  </div>
                  <div>
                    {metrics.avgCapacityUtilization < 70 ? (
                      <div className="bg-green-100 text-green-800 text-xs font-medium py-1 px-2 rounded">Optimal</div>
                    ) : metrics.avgCapacityUtilization < 80 ? (
                      <div className="bg-blue-100 text-blue-800 text-xs font-medium py-1 px-2 rounded">Normal</div>
                    ) : (
                      <div className="bg-yellow-100 text-yellow-800 text-xs font-medium py-1 px-2 rounded">High</div>
                    )}
                  </div>
                </div>
                ...
                <div className="mt-4 h-8 bg-gray-200 rounded-full overflow-hidden">
                  <div 
                    className="h-full rounded-full" 
                    style={{ 
                      width: `${Math.min(metrics.avgCapacityUtilization, 100)}%`, 
                      backgroundColor: metrics.avgCapacityUtilization < 70 ? colors.success : 
                                      metrics.avgCapacityUtilization < 80 ? colors.chart5 : 
                                      metrics.avgCapacityUtilization < 90 ? colors.warning : 
                                      colors.error
                    }}
                  ></div>
                </div>
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <h3 className="text-sm font-semibold mb-3" style={{ color: colors.primary }}>Source Distribution</h3>
                <div className="h-40">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                        data={[
                          { name: 'Tanker Sewage', value: 100 - metrics.avgDirectSewagePercentage },
                          { name: 'Direct Sewage', value: metrics.avgDirectSewagePercentage },
                        ]}
                        cx="50%"
                        cy="50%"
                        outerRadius={60}
                      ...
                      >
                        ...
                        <Cell fill={colors.chart5} />
                      </Pie>
                      <Tooltip formatter={(value) => `${value.toFixed(1)}%`} />
                    </PieChart>
                  </ResponsiveContainer>
                </div>
                <p className="text-xs text-gray-500 mt-2 text-center">* Direct sewage has increased from 47.9% to {data.length > 0 ? data[data.length-1].directSewagePercentage.toFixed(1) : 'N/A'}% over the period</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Trends Over Time */}
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <h3 className="text-sm font-semibold mb-4" style={{ color: colors.primary }}>Performance Trends</h3>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data}>
                      <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
