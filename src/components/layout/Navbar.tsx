        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden md:block">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-64 py-2 pl-10 pr-4 text-sm transition-all border rounded-full focus:outline-none focus:ring-2 focus:ring-muscat-primary/20 border-muscat-primary/10 bg-muscat-light"
            />
          </div>
          ...
          <div className="flex items-center gap-3 pl-4 border-l border-muscat-primary/10">
            <div className="hidden text-right md:block">
              <p className="text-sm font-medium text-muscat-primary">Admin User</p>
