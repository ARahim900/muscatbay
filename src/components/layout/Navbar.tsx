      ...
      <div className="flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <div className="relative hidden md:block">
            ...
            <input type="text" placeholder="Search..." className="w-56 md:w-64 py-2 pl-10 pr-4 text-sm transition-all border rounded-full focus:outline-none focus:ring-2 focus:ring-muscat-primary/20 border-muscat-primary/10 bg-muscat-light" />
          </div>
