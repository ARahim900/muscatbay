      ...
      <ErrorBoundary>
        <div className="p-6 space-y-6 animate-fade-in">
          <div className="flex items-center mb-4">
            <Badge
              variant="outline"
              className={`${error ? "bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border-red-200 dark:border-red-800/50" : "bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 border-green-200 dark:border-green-800/50"}`}
            >
              <Zap className="h-3 w-3 mr-1" />
              {error ? "Database Connection Error" : "Connected to Airtable Database"}
            </Badge>
          </div>
